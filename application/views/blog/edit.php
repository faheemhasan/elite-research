...
<div class='col-lg-10'>
<textarea class='form-control mceEditor' rows='5' name='description'><?php echo $rows->description; ?></textarea>
...
<br><br><img style='width:200px; height:200px;' src='<?php echo base_url(); ?>assets/uploads/blog/<?php echo $rows->image; ?>'>
