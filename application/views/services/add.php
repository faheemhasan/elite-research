...
<div class='col-lg-10'>
<textarea class='mceEditor form-control' rows='5' name='description'><?php echo set_value('description'); ?></textarea>
...
<div class='col-lg-10'>
<input type='text' class='form-control' name='monthly' value='<?php echo set_value("monthly"); ?>'> 
...
<div class='col-lg-10'>
<input type='text' class='form-control' name='quarterly' value='<?php echo set_value("quarterly"); ?>'> 
...
<div class='col-lg-10'>
<input type='text' class='form-control' name='half_yearly' value='<?php echo set_value("half_yearly"); ?>'> 
...
<div class='col-lg-10'>
<input type='text' class='form-control' name='yearly' value='<?php echo set_value("yearly"); ?>'> 
...
<div class='col-lg-10'>
<input type='text' class='form-control' name='bg_color' value='<?php echo set_value("bg_color"); ?>'> 
...
<div class='col-lg-10'>
 <select class="form-control" name="home_featured" >
   <option <?php if(set_value('home_featured')=="no") echo "selected" ?> value="no">No</option>
   <option <?php if(set_value('home_featured')=="yes") echo "selected" ?> value="yes">Yes</option>
 </select>
<span class='error'></span>
</div>
</div>
...
<div class='col-lg-10'>
 <select class="form-control" name="about_us_featured" >
   <option <?php if(set_value('about_us_featured')=="no") echo "selected" ?> value="no">No</option>
   <option <?php if(set_value('about_us_featured')=="yes") echo "selected" ?> value="yes">Yes</option>
 </select>
<span class='error'></span>
</div>
</div>
...
<div class='col-lg-10'>
 <select class="form-control" name="footer_featured">
   <option <?php if(set_value('footer_featured')=="no") echo "selected" ?> value="no">No</option>
   <option <?php if(set_value('footer_featured')=="yes") echo "selected" ?> value="yes">Yes</option>
 </select>
<span class='error'></span>
</div>
</div>
...
<div class='col-lg-10'>
 <select class="form-control" name="free_trial">
   <option <?php if(set_value('free_trial')=="no") echo "selected" ?> value="no">No</option>
   <option <?php if(set_value('free_trial')=="yes") echo "selected" ?> value="yes">Yes</option>
 </select>
<span class='error'></span>
</div>
</div>
