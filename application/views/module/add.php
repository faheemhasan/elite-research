...
<section class="panel">
    ...
    <div id='form_fields' class="form-group">
        ...
        <button onclick='faraz();' style='margin-top:50px;' type="submit" class="btn btn-sm btn-default">Create Module</button>
    <?php echo form_close(); ?>
    </div>
</section>
...
function create_form_fields()
{
    ...
    form_content += "<tr><th>Field Name</th><th>Display Name</th><th>Field Type</th><th>Validation Rule</th><th>Match With</th><th>Min Length</th><th>Max Length</th><th>Exact Length</th></tr>"; 
    form_content += ""; 
    $('.db_table').each(function(){
        id = $(this).attr('id');
        fname = $('#'+id+' .fname').val().toLowerCase();
        form_content += "<tr id='tr_id_'"+i+">";
        form_content += "<td style='color:#E75D59; font-size:16px;'>"+fname.toUpperCase()+"</td>"; 
        ...
        form_content += "<option value='100'>Image Validation</option>";
