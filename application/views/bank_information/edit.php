...
<br><br><img style='width:150px; height:100px;' src='<?php echo base_url(); ?>assets/uploads/bank_information/<?php echo $rows->bank_logo; ?>'>
...
<div class='col-lg-10'>
<input type='text' class='form-control' name='account_name' value='<?php echo $rows->account_name; ?>'> 
...
<div class='col-lg-10'>
<input type='text' class='form-control' name='account_number' value='<?php echo $rows->account_number; ?>'> 
...
<div class='col-lg-10'>
<input type='text' class='form-control' name='branch_name' value='<?php echo $rows->branch_name; ?>'> 
...
<div class='col-lg-10'>
<input type='text' class='form-control' name='ifsc_code' value='<?php echo $rows->ifsc_code; ?>'> 
