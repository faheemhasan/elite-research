...
function()
	{
		...
		/*jQuery('.btn-color').live('click',
		function()
			{
			jQuery(this).closest('.form_field').find('input').trigger('change');
			}
		);*/
