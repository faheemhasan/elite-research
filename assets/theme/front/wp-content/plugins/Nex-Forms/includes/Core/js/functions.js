...
/*******************/	
		...
		//jQuery( "#single_date" ).datetimepicker();
...
/************************************/
	...
	jQuery('input[type="file"][name="featured_image"]').live('focus',
		function()
			{
			jQuery('fieldset.featured_image legend').html('Image');
	...
	jQuery('input[type="file"][name="featured_image"]').live('change',
		function()
			{	
			...
			form.attr("action",jQuery('div#site_url').text() +"/wp-content/plugins/Core/class.filehandler.php?upload_uri="+ jQuery('div#upload_uri').text() +"&upload_path="+ jQuery('div#upload_path').text() +"&session_Id="+ jQuery('input[name="session_Id"]').val());
		...
		jQuery('input[type="file"][name="featured_image"]').trigger('focus');
/************************************/
