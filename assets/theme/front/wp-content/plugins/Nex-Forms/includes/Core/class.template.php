...
if(!class_exists('IZC_Template'))
	...
	class IZC_Template{
		...
		public function build_header($title='',$subtitle='',$menu='',$description='',$plugin_alias=''){
			...
			//$this->page_header  .= '<div class="plugin_header"><div class="wa_logo"><a href="http://webaways.com"></a></div>'.((!$_REQUEST['tutorial']) ? '<div class="view-tutorial"><a href="?page='.$_REQUEST['page'].'&tutorial=true"></a></div>' : '<div class="exit-tutorial"><a ></a></div>' );
			$this->page_header  .= '</div>';
			
			//if($title)
				//$this->page_header .= '<div class="xforms_logo '.$component_table.'">';$this->page_header .= '</div>';
