 ...
 */
	if ( !function_exists( 'mmm_menu_options_array' ) ) {
		...
		/* for better times
						array(
							...
							'type' => 'select',
							'values' => array(
								__( 'Hide Mega Options', $mega_main_menu->constant[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'false',
								__( 'Show Mega Options', $mega_main_menu->constant[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'true',
							),
							'dependency' => array(
								'element' => array( 
									'item_icon', 
	...
	/*
						array(
							...
							'type' => 'checkbox',
							'values' => array(
								__( 'Hide Icon of This Item', $mega_main_menu->constant[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'true',
							),
						),
	*/
		...
		/* for better times
							array(
								...
								__( 'Grid Dropdown', $mega_main_menu->constant[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'grid_dropdown',
								__( 'Posts Grid Dropdown', $mega_main_menu->constant[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'post_type_dropdown',
								__( 'Widgets First Area Dropdown', $mega_main_menu->constant[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'widgets_first_dropdown',
								__( 'Widgets Second Area Dropdown', $mega_main_menu->constant[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'widgets_second_dropdown',
								__( 'Custom Content Dropdown', $mega_main_menu->constant[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'custom_dropdown',
							),
		*/
							'dependency' => array(
								'element' => array( 
		...
		/* for better times
						array(
							...
							'type' => 'checkbox',
							'values' => array(
								__( 'Disable Submenu Icons', $mega_main_menu->constant[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'true',
							),
						),
		*/
						array(
		...
		/* for better times
						array(
							'descr' => __( 'Custom Content (Shorcodes supported, only for "Multicolumn" and "Custom" Dropdown)', $mega_main_menu->constant[ 'MM_TEXTDOMAIN_ADMIN' ] ),
