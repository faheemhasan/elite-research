 ...
 */
				...
				$locations_options = array_merge( 
					$locations_options, array(
						...
						array(
							...
							'values' => '30',
							'dependency' => array(
								'parent' => 'mega_main_menu_options[' . $key . '_primary_style]', 
								'values' => array(
									'buttons',
								),
							),
						...
						array(
							...
							'default' => 'Menu',
							'dependency' => array(
								'parent' => 'mega_main_menu_options[' . $key . '_mobile_minimized]', 
								'values' => array(
									'true',
								),
							),
	...
	*/
						array(
							...
							'values' => '40',
							'dependency' => array(
								'parent' => 'mega_main_menu_options[' . $key . '_direction]', 
								'values' => array(
									'horizontal',
								),
							),
						...
						array(
							...
							'descr' => __( 'Check this option to make the menu sticky. Not working on mobile devices.', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
						...
						array(
							...
							'default' => 340,
							'dependency' => array(
								'parent' => 'mega_main_menu_options[' . $key . '_sticky_status]', 
								'values' => array(
									'true',
								),
							),
			...
			$locations_options = array_merge( 
				$locations_options, array(
					...
					array(
						'name' => __( 'Backup of the settings', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
						'descr' => __( 'You can make a backup of the plugin settings and restore this settings later. Notice: Options of each menu item from the section "Menu Structure" is not imported.', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
						'key' => 'backup',
						'type' => 'just_html',
			...
			$skins_options = array_merge( 
				$skins_options, array(
					...
					array(
						...
						'descr' => __( 'Here you can add and edit highlighting styles.', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] )	,
