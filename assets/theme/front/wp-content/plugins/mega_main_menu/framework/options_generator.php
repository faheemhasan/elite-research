	...
	function mm_options_generator( $option, $mm_saved_value = false, $current_class = 'none' ){
		...
		switch ( $option['type'] ) {
			...
			case 'number':
				...
				$input = '<input class="form-control input-sm col-xs-12" type="number" step="' . $step . '" min="' . $min . '" max="' . $max . '" name="' . $option['key'] . '" value="' . ( ( isset( $mm_saved_value ) && $mm_saved_value !== false ) 
			...
			case 'icons':
				...
				$out .= mm_common::ntab(9) . '<div class="row">';
				$out .= mm_common::ntab(10) . '<div class="input-group input-group-sm col-xs-9">';
				$out .= mm_common::ntab(11) . '<input class="form-control input-sm wpb_vc_param_value" type="text" name="' . $option['key'] . '" value="' . $icon . '" data-icon="icons_list_' . esc_attr( $clear_full_key ) . '" />';
				$out .= mm_common::ntab(11) . '<span class="input-group-btn">';
				...
				$out .= mm_common::ntab(11) . '<i class="' . $icon . '" data-icon="icons_list_' . $clear_full_key . '"></i>';
				$out .= mm_common::ntab(10) . '</div><!-- class="col-xs-3" -->';
				$out .= mm_common::ntab(9) . '</div><!-- class="row" -->';
...
*/
			...
			case 'color':
				...
				$out .= mm_common::ntab(10) . '<input class="form-control col-xs-12" type="text" name="' . $option['key'] . '" value="' . $value . '">';
