	...
	if ( is_admin() && isset($_GET['importcontent']) ) {
		...
		if ( class_exists( 'WP_Importer' ) && class_exists( 'pvt_WP_Import' ) ) {
			...
			if ( $_GET['importcontent'] == 'alldemocontent' ) {
				...
				$files_to_import[] = $import_path . 'seowp-media-1.xml.gz';
				$files_to_import[] = $import_path . 'seowp-media-2.xml.gz';
				$files_to_import[] = $import_path . 'seowp-media-3.xml.gz';
				...
				$files_to_import[] = $import_path . 'seowp-predesignedpages-4.xml.gz';
				$files_to_import[] = $import_path . 'seowp-predesignedpages-5.xml.gz';
